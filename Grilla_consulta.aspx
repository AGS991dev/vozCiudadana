<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/master.master" CodeFile="Grilla_consulta.aspx.vb" Inherits="Grilla_consulta" %>

<asp:Content runat="server" ContentPlaceHolderID="contenido_nav">
    <a href="supervisor_index.aspx" class="breadcrumb">INICIO</a>
    <a href="#" class="breadcrumb ACTIVE">CONSULTAS</a>
</asp:Content>

<asp:Content runat="server" ContentPlaceHolderID="contenido_body">

    <h1 style="text-align:center">Consultas</h1>
    <p class="center">Aquí verás las compras realizadas y pedidos entregados</p>
        <div >
                                            ...
                                            <div class="card" style="min-height:70vh;padding: 30px;">
                                                    ...
                                                    <div class="contenedor_filtros" style="display: flex;margin: auto;flex-wrap: wrap;">
                                                        <div class="inputs_filtros_css" >
                                                            ...
                                                            <div style="position:relative;top:17px">
                                                                <asp:DropDownList runat='server' ID='cbo_ticket' type='text' class='form-control input-md' style="min-width:70px;" MaxLength='200' />
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="inputs_filtros_css">
                                                                <label for="txt_desde" class="txt_desde" style="min-width: 90px;margin: 8px;position: relative;top: 5px;">Desde:</label>
                                                                 <asp:UpdatePanel ID="Update_txt_desde" runat="server" UpdateMode="Conditional">
                                                                    <ContentTemplate>
                                                                        <asp:TextBox runat='server' ID='txt_desde'  type='date' class='form-control input-md ' MaxLength='200' />
                                                                     </ContentTemplate>
                                                                </asp:UpdatePanel>
                                                        </div>
                                                        <div class="inputs_filtros_css">
                                                                <label for="txt_hasta" class="txt_hasta" style="min-width: 90px;margin: 8px;position: relative;top: 5px;">Hasta:</label>
                                                                 <asp:UpdatePanel ID="Update_txt_hasta" runat="server" UpdateMode="Conditional">
                                                                     <ContentTemplate>
                                                                        <asp:TextBox runat='server' ID='txt_hasta' type='date' class='form-control input-md ' MaxLength='200' />
                                                                     </ContentTemplate>
                                                                </asp:UpdatePanel>
                                                        </div>
                                                ...
                                                <br />
                                                    ...
                                                    <Columns>
                                                       ...
                                                       <ASP:BoundField DataField = "cantidad_total" htmlencode="false" HeaderText="Cantidad 🎲" />
...
<asp:Content runat="server" ContentPlaceHolderID="contenido_js">
    <script type="text/javascript">
        $('document').ready(function () {
            ...
            //incializar_calendario("<%=txt_desde.ClientID%>")
            //incializar_calendario("<%=txt_hasta.ClientID%>")
