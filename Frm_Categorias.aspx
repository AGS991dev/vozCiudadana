<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/master.master" CodeFile="Frm_Categorias.aspx.vb" Inherits="Frm_Categorias" %>

<asp:Content runat="server" ContentPlaceHolderID="contenido_nav">
    <a href="supervisor_index.aspx" class="breadcrumb">INICIO</a>
    <a href="Grilla_Categorias.aspx" class="breadcrumb">Categorías</a>
        ...
        <div class="form-card">
            ...
            <form runat="server" class="form-horizontal" autocomplete="off">
                ...
                <div class="input-field ">
                    ...
                    <label for="txt_descripcion">Descripción de la categoría</label>
                </div>
